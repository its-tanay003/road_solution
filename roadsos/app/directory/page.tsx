...
export const metadata: Metadata = {
  title: 'Emergency Directory — ROADSoS',
  description: 'Pan-India emergency services directory — hospitals, police, fire, helplines.',
};

const EMERGENCY_SERVICES = [
  // National Helplines
  { category: 'National Helplines', entries: [
  ...
  { category: 'International', entries: [
    ...
    <div className="min-h-screen bg-gray-950 text-white pb-24">
      ...
      <header className="px-5 pt-14 pb-5 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-black text-white text-xl">Emergency Directory</h1>
            <p className="text-gray-500 text-xs">Pan-India + International helplines</p>
          </div>
        </div>
      </header>
      ...
      <div className="px-5 py-5 space-y-6">
        ...
        <div className="bg-blue-950/40 border border-blue-800/50 rounded-2xl p-4 text-center">
          ...
          <p className="text-blue-200 text-sm font-medium">Know a local helpline we&apos;re missing?</p>
          <p className="text-blue-400 text-xs mt-1">Crowd-sourced updates coming soon</p>
        </div>
      </div>
    </div>
  );
