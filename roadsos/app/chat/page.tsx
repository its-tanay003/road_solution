...
export default function ChatPage() {
  ...
  }, [isStreaming, model, messages, addMessage, updateLastMessage, setStreaming, buildContext]);
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-950 text-white pb-16">
      ...
      <header className="flex items-center justify-between px-5 pt-14 pb-3 border-b border-gray-800 shrink-0">
        <h1 className="font-black text-lg text-white">AI Emergency Assistant</h1>
        <button onClick={clearHistory} className="p-2 rounded-xl bg-gray-900 border border-gray-700 hover:bg-gray-800" aria-label="Clear history">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center py-8 space-y-4">
            <p className="text-gray-400 text-sm">Ask about first aid, emergencies, or safety tips.</p>
