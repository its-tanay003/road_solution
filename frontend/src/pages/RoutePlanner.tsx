...
export const RoutePlanner = () => {
  return (
    <div className="min-h-screen bg-(--nx-bg-base) text-(--nx-text-primary) flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-[400px] bg-(--nx-bg-surface) border-r border-(--nx-border) flex flex-col z-20">
      ...
      <div className="flex-1 relative overflow-hidden bg-black">
        ...
        <div className="absolute top-8 left-8 z-30">
           <div className="nexus-card bg-(--nx-bg-surface)/80 backdrop-blur-md p-4 flex items-center gap-6">
