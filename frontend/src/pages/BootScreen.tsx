...
import { ShieldAlert, Zap, Globe, Cpu, Database, Wifi } from 'lucide-react';
...
export const BootScreen: React.FC<BootScreenProps> = ({ onComplete }) => {
  ...
  const bootMessages = [
    ...
    "[ OK ] CLAUDE-4 ANALYTICS HUB CONNECTED",
    "[ OK ] OPENROUTER REASONING CORE: ONLINE (G4-31B)",
    ...
    <div className="fixed inset-0 bg-[#0A0C0F] z-[10000] flex flex-col items-center justify-center font-sans overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
         ...
         >
            ...
            <motion.div 
              ...
              className="absolute inset-0 bg-[var(--nx-red-primary)] rounded-full blur-[80px]"
            />
            
            <div className="relative w-32 h-32 flex items-center justify-center border border-[var(--nx-border)] rounded-sm bg-[#0F1218]">
               <ShieldAlert size={64} className="text-[var(--nx-red-primary)] drop-shadow-[0_0_20px_rgba(255,59,59,0.5)]" />
            ...
            <div className="flex items-center gap-1 mb-4">
               {[...Array(20)].map((_, i) => (
                 <motion.div 
                   ...
                   className={`w-1.5 h-4 rounded-sm ${i > 15 ? 'bg-[var(--nx-red-primary)] shadow-[0_0_8px_var(--nx-red-primary)]' : 'bg-[var(--nx-blue-primary)]'}`}
                 />
               ))}
            </div>
            <div className="flex items-center gap-8 text-[9px] font-mono font-bold text-[var(--nx-text-dim)] uppercase tracking-widest">
      ...
      <div className="absolute bottom-16 left-16 max-w-lg">
         <div className="flex items-center gap-3 mb-4">
            <div className="w-1.5 h-1.5 bg-[var(--nx-green-primary)] rounded-full animate-pulse shadow-[0_0_4px_var(--nx-green-primary)]" />
         ...
         <div className="space-y-1.5 h-32 overflow-hidden flex flex-col-reverse">
            {logs.slice().reverse().map((log, i) => (
              <motion.div 
                ...
                className="font-mono text-[10px] text-[var(--nx-text-tertiary)] uppercase flex items-center gap-3"
              >
      ...
      <div className="absolute bottom-16 right-16 text-right">
         ...
         <div className="text-[9px] font-mono text-[var(--nx-text-dim)] uppercase tracking-tighter">NEXUS TACTICAL INTERFACE • 2026 ROADSoS</div>
      </div>
