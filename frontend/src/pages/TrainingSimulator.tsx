      ...
      <div className="flex-1 p-6 md:p-12 max-w-6xl mx-auto w-full flex flex-col h-full">
        ...
        <AnimatePresence mode="wait">
          {phase === 'SETUP' && (
            ...
            >
              {/* Prebuilt */}
              <div className="bg-[var(--nx-bg-surface)] border border-[var(--nx-border)] rounded-2xl p-6">
              ...
              {/* Custom */}
              <div className="bg-[var(--nx-bg-surface)] border border-[var(--nx-border)] rounded-2xl p-6 flex flex-col">
          ...
          {phase === 'ACTIVE' && (
            ...
            >
              {/* Scenario Feed */}
              <div className="md:col-span-2 flex flex-col bg-[var(--nx-bg-surface)] border border-[var(--nx-border)] rounded-2xl overflow-hidden">
          ...
          {phase === 'DEBRIEF' && (
            <motion.div 
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="max-w-3xl mx-auto w-full bg-[var(--nx-bg-surface)] border border-[var(--nx-border)] rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden"
            >
