...
export const TriageChat = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-nx-bg-base relative overflow-hidden font-sans">
      ...
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-nx-border bg-nx-bg-[var(--color-surface)]/80 backdrop-blur-md z-20">
              ...
              <div className={`max-w-[85%] relative ${msg.role === 'user' ? 'text-right' : 'text-left'}`}>
                ...
                <div className={`p-4 rounded-sm border ${
                  msg.role === 'user' 
                    ...
                    : 'bg-nx-bg-[var(--color-surface)] border-nx-border text-nx-text-secondary leading-relaxed text-sm'
                }`}>
                  {msg.content}
      ...
      {/* Input Area */}
      <div className="p-4 bg-nx-bg-[var(--color-surface)] border-t border-nx-border space-y-4">
