...
export const SOSActive = () => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="fixed inset-0 z-2000 bg-emergency text-white p-6 flex flex-col items-center justify-between overflow-y-auto"
    >
      ...
      <div className="flex flex-col items-center text-center space-y-6">
        ...
        >
          <ShieldAlert size={64} className="text-emergency" />
        </motion.div>
        ...
        <div className="w-full max-w-sm bg-white/10 rounded-[2.5rem] p-6 border-2 border-white/20 backdrop-blur-md">
          <div className="flex items-center gap-4 mb-4">
            <CheckCircle2 size={24} className="text-safe" />
            <p className="text-lg font-black uppercase tracking-tight">Location Sent</p>
          </div>
          <div className="flex items-center gap-4 mb-4">
            <CheckCircle2 size={24} className="text-safe" />
            <p className="text-lg font-black uppercase tracking-tight">Police Notified</p>
          </div>
      ...
      <div className="w-full max-w-sm space-y-4 pb-8">
        <button className="w-full h-20 bg-white text-emergency rounded-3xl flex items-center justify-center gap-4 shadow-xl active:scale-95 transition-all">
