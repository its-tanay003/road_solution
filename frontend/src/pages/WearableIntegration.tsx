                  ...
                  <div key={device.id} className="nexus-card p-4 border-nx-border/50 bg-white/2 hover:bg-white/5 transition-all group">
                    <div className="flex items-start justify-between">
                      <div className="flex gap-3">
                        <div className={`p-2 rounded-(--radius-lg) ${device.status === 'CONNECTED' ? 'bg-nx-blue-primary/10 text-nx-blue-primary' : 'bg-white/5 text-nx-text-tertiary'}`}>
                  ...
                  {activeAlerts.length > 0 ? (
                    activeAlerts.map((alert, i) => (
                      <motion.div 
                        ...
                        exit={{ opacity: 0, x: 20 }}
                        className="flex items-center justify-between p-3 rounded-(--radius-lg) bg-nx-red-primary/10 border border-nx-red-primary/20"
                      >
                        <div className="flex items-center gap-3">
