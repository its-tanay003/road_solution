  ...
  return (
    <div className="min-h-screen bg-nx-bg-base text-nx-text-primary p-6 pb-24 lg:pb-10 overflow-y-auto">
      <div className="max-w-2xl mx-auto space-y-8">
             ...
             <AnimatePresence>
               {isAnalyzing && (
                 <motion.div 
                   ...
                   animate={{ opacity: 1 }}
                   exit={{ opacity: 0 }}
                   className="absolute inset-0 bg-nx-bg-[var(--color-surface)]/95 backdrop-blur-md z-50 flex flex-col items-center justify-center text-center p-8 border border-nx-blue-primary/30 rounded-sm"
                 >
        ...
        <div className="nexus-card p-6 mb-8 bg-nx-bg-[var(--color-surface)]/95 border-nx-blue-primary/30">
