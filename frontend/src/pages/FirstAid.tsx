    ...
    <div className="min-h-screen bg-nx-bg-base text-nx-text-primary p-6 pb-24 lg:pb-10 overflow-y-auto">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="relative group">
           ...
           <input 
              className="nexus-input w-full pl-12 py-4 bg-nx-bg-(--color-surface) border border-nx-border/50 focus:border-nx-blue-primary/50 text-sm"
        ...
        <div className="nexus-card bg-nx-bg-(--color-surface) border-nx-border overflow-hidden shadow-2xl">
