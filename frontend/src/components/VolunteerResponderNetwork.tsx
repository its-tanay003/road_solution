  ...
  if (showReg) {
    return (
      <div className="fixed inset-0 z-1100 flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
        ...
        >
          <Panel className="p-8 border-(--nx-blue-primary)/30 bg-linear-to-b from-(--nx-bg-(--color-surface)) to-(--nx-bg-elevated)">
      ...
      <Panel className="p-4 bg-blue-500/5 border-blue-500/20">
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-500 rounded-full border-2 border-(--nx-bg-(--color-surface))" />
          </div>
          <div>
