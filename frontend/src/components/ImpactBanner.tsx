        ...
        >
          <div className="bg-night/90 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden relative group">
            ...
            <div className="flex gap-4">
              <div className="w-12 h-12 rounded-xl bg-sos-red/20 flex items-center justify-center shrink-0">
                <AlertCircle className="text-sos-red" size={24} />
              </div>

              <div className="flex-1 pr-4">
                <h3 className="text-white font-bold text-sm mb-1">Critical Impact Alert</h3>
                <p className="text-text-muted text-xs leading-relaxed mb-3">
                  Every <span className="text-sos-red font-bold underline decoration-sos-red/30">3.4 minutes</span>, an Indian dies on the road. 
                  ROADSoS reduces coordination time from 9.2 minutes to <span className="text-safe-green font-bold">under 90 seconds</span>.
                </p>
