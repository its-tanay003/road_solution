        ...
        <div className="p-8 space-y-8 border-r border-(--clr-border)">
          ...
          <div className="space-y-4">
            ...
            <input 
              ...
              className="w-full h-1.5 bg-white/10 rounded-[var(--radius-lg)] appearance-none cursor-pointer accent-(--clr-blue)"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full h-1.5 bg-white/10 rounded-[var(--radius-lg)] appearance-none cursor-pointer accent-(--clr-amber)"
            ...
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full h-1.5 bg-white/10 rounded-[var(--radius-lg)] appearance-none cursor-pointer accent-(--clr-green)"
