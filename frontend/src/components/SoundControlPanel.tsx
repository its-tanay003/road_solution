        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="flex items-center gap-3">
              <div className="p-2 bg-indigo-500/20 rounded-(--radius-lg)">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-1 w-32">
                ...
                <input 
                  ...
                  className="w-full h-1 bg-slate-800 rounded-(--radius-lg) appearance-none cursor-pointer accent-indigo-500"
                />
              </div>
            </div>
          </div>
