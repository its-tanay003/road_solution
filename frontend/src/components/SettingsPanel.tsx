          ...
          >
            ...
            <div className="p-8 bg-(--app-surface) border-b-4 border-(--app-border) flex justify-between items-center">
              <div>
                ...
                <p className="text-xs font-black text-emergency tracking-widest uppercase mt-1">Accessibility Controls</p>
              </div>
              <button 
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-12 pb-40">
              ...
              <section className="space-y-6">
                <h3 className="text-xl font-black flex items-center gap-3 text-(--app-text) uppercase tracking-tight">
                  <div className="p-2 bg-amber/20 rounded-lg text-amber">
              ...
              <section className="space-y-6">
                <h3 className="text-xl font-black flex items-center gap-3 text-(--app-text) uppercase tracking-tight">
                  <div className="p-2 bg-emergency/20 rounded-lg text-emergency">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {['hold', 'tap'].map((mode) => (
                    <button
                      ...
                      className={`h-24 flex items-center justify-between px-8 rounded-3xl border-4 transition-all active:scale-[0.98] ${
                        sosTriggerMode === mode 
                        ? 'border-emergency bg-emergency text-white shadow-xl' 
                        : 'border-(--app-border) bg-(--app-surface) text-(--app-text)'
                      }`}
                    >
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`p-2 rounded-xl ${isReducedMotion ? 'bg-white/20' : 'bg-safe/20 text-safe'}`}>
              ...
              <section className="space-y-6">
                <h3 className="text-xl font-black flex items-center gap-3 text-(--app-text) uppercase tracking-tight">
                  <div className="p-2 bg-navy/20 rounded-lg text-navy">
                ...
                <p className="text-xs font-black text-emergency uppercase tracking-widest px-4">
