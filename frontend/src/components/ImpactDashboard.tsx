          ...
          {[
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className={`p-2 rounded-(--radius-lg) bg-slate-950 border border-white/5 ${stat.color} group-hover:scale-110 transition-transform`}>
                  {stat.icon}
                </div>
          ...
          <div className="bg-slate-900/50 border border-white/5 p-8 rounded-3xl flex flex-col">
            ...
            <div className="space-y-10 flex-1">
              ...
              <input 
                ...
                className="w-full h-1.5 bg-slate-800 rounded-(--radius-lg) appearance-none cursor-pointer accent-emerald-500 transition-all hover:h-2"
              />
